                ...
                <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" sx={{
                    ...
                    <Stack sx={{
                        ...
                        <Box sx={{ 
                            ...
                            <TextField sx={{ gridColumn: "4 / 9" }} id="userID" label="User ID" size="small" variant="filled" value={username} disabled/>
                            <Typography sx={{ gridColumn: "1 / 4" }} variant="h6">No IN:</Typography>
                            <TextField autoComplete="off" sx={{ gridColumn: "4 / 9" }} multiline value={!!savedRequest.NoIN ? savedRequest.NoIN : noIN} id="noIN" label="No IN" variant="filled" size="small" disabled/>
                            <Typography sx={{ gridColumn: "1 / 4" }} variant="h6">Tipe Kalkual:</Typography>
                            <TextField sx={{ gridColumn: "4 / 9" }}
                                size="small"
                                id="tipeKalkual"
                                select
                                label="Tipe Kalkual"
                            ...
                            <TextField autoComplete="off" sx={{ gridColumn: "4 / 9" }} defaultValue={savedRequest.NamaAlat} id="nama" label="Nama Alat/Mesin/Sistem Penunjang/Ruangan" inputRef={namaRef} size="small"/>
                            <Typography sx={{ gridColumn: "1 / 4" }} variant="h6">Tipe Alat:</Typography>
                            <TextField autoComplete="off" sx={{ gridColumn: "4 / 9" }}
                                size="small"
                                id="tipeAlat"
                                select
                            ...
                            <TextField autoComplete="off" sx={{ gridColumn: "4 / 9" }} defaultValue={savedRequest.NoKontrol} id="noKontrol" label="No Kontrol" inputRef={noKontrolRef} size="small" variant={isRuangan ? "filled" : "outlined"} disabled={isRuangan}/>
                            <Typography sx={{ gridColumn: "1 / 4" }} variant="h6">Tahun Pembelian:</Typography>
                            <TextField autoComplete="off" sx={{ gridColumn: "4 / 9" }} defaultValue={savedRequest.Tahun} id="tahun" label="Tahun Pembelian" inputRef={tahunRef} size="small" variant={isRuangan ? "filled" : "outlined"} disabled={isRuangan}/>
                            <Typography sx={{ gridColumn: "10 / 13", gridRow: "1" }} variant="h6">Departemen:</Typography>
                            <TextField autoComplete="off" sx={{ gridColumn: "13 / 18", gridRow: "1" }} defaultValue={savedRequest.Departemen} id="departemen" label="Departemen Pemilik" inputRef={departemenRef} size="small"/>
                            ...
                            <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={localeMap[locale]}>
                                <DatePicker inputFormat="dd-MM-yyyy" label="Tanggal Kalkual" value={savedRequest.TglKalkual} onChange={tgl => setTanggal(format(new Date(tgl), 'yyyy-MM-dd'))} renderInput={params => <TextField {...params} size="small" sx={{ gridColumn: "13 / 18", gridRow: "3" }}/>}/>
                            </LocalizationProvider>
                            <Typography sx={{ gridColumn: "10 / 13", gridRow: "4" }} variant="h6">Periode Kalkual:</Typography>
                            <TextField autoComplete="off" sx={{ gridColumn: "13 / 18", gridRow: "4" }} defaultValue={savedRequest.Periode} id="periodeKalkual" onChange={periodeChangeHandler} label="Periode Kalkual" size="small"/>
                            <Typography sx={{ gridColumn: "10 / 13", gridRow: "5" }} variant="h6">ED Kalkual:</Typography>
                            <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={localeMap[locale]}>
                                <DatePicker inputFormat="dd-MM-yyyy" label="ED Kalkual" value={savedRequest.EDKalkual} onChange={tgl => setTanggal(tgl)} renderInput={params => <TextField {...params} sx={{ gridColumn: "13 / 18", gridRow: "5" }} id="edKalkual" size="small" variant="filled" disabled/>}/>
                            </LocalizationProvider>
                            {location.state.kalibrasi !== null ? 
                                (location.state.kalibrasi ? 
                                    <><Typography sx={{ gridColumn: "10 / 13", gridRow: "6" }} variant="h6">Jenis Kalibrasi:</Typography>
                                    <TextField autoComplete="off" 
