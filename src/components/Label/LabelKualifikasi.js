            ...
            <ThemeProvider theme={theme}>
                <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" sx={{
                    ...
                    <Box width={0.95} backgroundColor="white" sx={{
                        ...
                        '& .MuiTableBody-root': { borderBottom: 1, borderColor: "rgb(200, 200, 200)"},
                    ...
                    <Box width={0.95} backgroundColor="rgb(200, 200, 200)" sx={{ 
                        border: 1,
                        borderColor: "rgba(0, 0, 0, 1)", 
                        borderWidth: "1px 4px 4px 4px",
                        direction: "rtl"
                    }}>
                        <Button sx={{ mr: 1.5 }} variant="text" size="small" onClick={() => navigate("/request/user")}>Request</Button>
                    </Box>
                </Box>
            </ThemeProvider>
        </Navbar>
