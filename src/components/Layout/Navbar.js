    ...
    return (
        <Box className={styles.background} display="flex" flexDirection="column" sx={{ minHeight: "100vh", maxWidth: "100vw" }}>
            ...
            <Box flex={1} display="flex">
                <Box position="fixed" zIndex={1} top={48} minHeight="100vh" sx={{backgroundColor: "rgba(0,0,0,0.8)", minWidth: 240, maxWidth: 240, borderRight: 1, borderRightWidth: 2, borderColor: "rgba(220, 220, 220, 0.8)"}}>
                    ...
                    <ThemeProvider theme={theme}>
                        ...
                        } title={<Typography variant="h6" sx={{ wordWrap: "break-word" }}>{user}</Typography>}/>   
                    </ThemeProvider>
                    <Divider light={true} variant="fullWidth" sx={{ bgcolor: "rgba(220, 220, 220, 0.8)", borderBottomWidth: 2 }}/>
                    <List>
                        ...
                        <Collapse in={menuVerifikasi} timeout="auto" unmountOnExit>
                            <List component="div" disablePadding>
                                ...
                                <ListItemButton onClick={() => {navigate("/verifikasi/timbangan")}} sx={{ pl: 7 }}>
                                    <ListItemIcon style={{minWidth: '40px', color: "white"}}>
                                        <ScaleIcon />
                                    </ListItemIcon>
